...
trajectory_point KDLPlanner::compute_circle_trajectory(double time) {
    ...
    circleddot << 0,
            4 * pow(M_PI, 2) * trajRadius_ * std::pow(abscissa.sdot, 2) * cos(2 * M_PI * abscissa.s) +
            2 * M_PI * trajRadius_ * pow(abscissa.sdot, 2) * sin(2 * M_PI * abscissa.s),
            4 * pow(M_PI, 2) * trajRadius_ * std::pow(abscissa.sdot, 2) * sin(2 * M_PI * abscissa.s) -
            2 * M_PI * trajRadius_ * pow(abscissa.sdot, 2) * cos(2 * M_PI * abscissa.s);
